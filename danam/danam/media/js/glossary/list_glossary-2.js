$(document).ready(function(){
		...
		$.ajax({
			...
			success: function(data){
				...
				for (i = 0; i < Object.keys(data.results.bindings).length; i++){
					/*---------- vertical layout--------------------------------------------
					...
					*/
					...
					if (data.results.bindings[i].img.value != ""){
						var general_head = "<tr><td><a href='../meaning/" + data.results.bindings[i].label.value + 
						"' target='_blank'>" + data.results.bindings[i].label.value + "</a></td><td>" + data.results.bindings[i].altlabel.value + "</td><td>" + 
						data.results.bindings[i].definition.value + "</td><td><a href='" + data.results.bindings[i].img.value + "' target='_blank'><img src='" 
						+ data.results.bindings[i].it.value + "' height='75px'></a></img><br>"
						...
						var general_head = "<tr><td><a href='../meaning/" + data.results.bindings[i].label.value + 
						"' target='_blank'>" + data.results.bindings[i].label.value + "</a></td><td>" + data.results.bindings[i].altlabel.value + "</td><td>" + 
						data.results.bindings[i].definition.value + "</td><td>";
					...
					if (user_name == 'anonymous') {
						...
						var edit_view = "<td><b><font color='red' size='1px'><span class = 'del' val = '"  
									...
									+ data.results.bindings[i].definition.value + "'>modify</span></font></b>";
				...
				$('.update').on("click", function(){
					...
					url: "/glossary/upload/",
					dataType: 'json',
					data: {"uuid": $(this).attr('uuid'), "eng": $(this).attr('eng'), "nep": $(this).attr('nep'), 
							"imag": $(this).attr('imag'), "thumb": $(this).attr('thumb'), "heidicon": $(this).attr('heidicon'),
							"def": $(this).attr('defn')},
					success: function(data){
